...
class ExpansionTailScreen extends StatefulWidget {
  ExpansionTailScreen({Key? key}) : super(key: key);

  @override
  _ExpansionTailScreenState createState() => _ExpansionTailScreenState();
}

class _ExpansionTailScreenState extends State<ExpansionTailScreen> {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [IconButton(onPressed: (){
            Get.toNamed('/Total_Screen');
        }, icon: Icon(Icons.keyboard_arrow_right,color: Colors.white,size: 35,))],
